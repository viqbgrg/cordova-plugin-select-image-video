...
- (void)autoPushPhotoCollectionViewController {
    ...
    if (self.autoPushToPhotoCollection) {
        ...
        [[XMNPhotoManager sharedManager] getAlbumsPickingVideoEnable:self.pickingVideoEnable getAlbumsPickingVideoOnly:self.pickingVideoOnly completionBlock:^(NSArray<XMNAlbumModel *> *albums) {
...
- (void)viewDidLoad {
    ...
    __weak typeof(*&self) wSelf = self;
    [[XMNPhotoManager sharedManager] getAlbumsPickingVideoEnable:imagePickerVC.pickingVideoEnable           getAlbumsPickingVideoOnly:imagePickerVC.pickingVideoOnly  completionBlock:^(NSArray<XMNAlbumModel *> *albums) {
